---
title: "Generation of Dynamic Human-aware Navigation Maps using Graph Neural Networks"
description: "SNGNN is a Graph Neural Network to model adherence to social-navigation conventions for robots."
cover: "@/images/projects/sngnn2d-v2/HAN.png"
coverAlt: "Human Pose Estimation with Graph Neural Networks"
lastUpdated: 2024-04-01
sidebar:
  order: 4
  label: "SNGNN2D-v2: Social Navigation with Graph Neural Networks 2D (version 2)"
---
...
<Header
	contributors={["Daniel Rodriguez-Criado", "Pilar Bachiller", "George Vogiatzis", "Luis J. Manso"]}
...
import reapPathImage from "@/images/projects/sngnn2d-v2/real_path.jpg";

<Image class="centered" src={reapPathImage} alt="Graphical interface of the demo tool" />
...
3. ###### Install in your local machine:
...
3. ###### Install with docker:
	You need to have docker-compose installed for this option
	```bash
