---
title: "SocNav1 - A Dataset to Benchmark and Learn Social Navigation Conventions (version 1)"
description: "A dataset for social navigation with robots. It captures the positions of humans, objects, and the robot within a room environment. As labels, it includes a discomfort score that quantifies how the robot's current location disrupts people's comfort."
...
sidebar:
  order: 5
  label: "SocNav1 Dataset (Static data)"
---
...
This dataset comprises single-frame scenarios depicting a room populated with humans, objects, and a robot, as illustrated in [Fig. 1](#fig-1). Blue ellipses represent humans, green rectangles objects, and the red square denotes the robot. Two types of interactions are represented by black lines: human-human interactions (see [Fig. 1 (left)](#fig-1)) and human-object interactions (see [Fig. 1 (right)](#fig-1)).
