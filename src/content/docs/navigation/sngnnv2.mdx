---
title: "SNGNNv2 - A graph neural network to model disruption in human-aware robot navigation"
...
sidebar:
  order: 3
  label: "SNGNNv2 - Social Navigation with Graph Neural Networks (version 2)"
---
