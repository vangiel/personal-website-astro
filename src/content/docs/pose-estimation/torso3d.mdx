...
<p class="caption">**Fig 1.** _Torso detection in a real environment (first row) and in CoppeliaSim (second row)._</p>
...
The first row of **Fig 1.** displays images of the real environment, while the second row shows a representation in [CoppeliaSim](https://www.coppeliarobotics.com/) of three views of the environment where the system has been tested. 
...
<p class="caption">**Fig 2.** _Representation of the pipeline of the system for torso pose estimation._</p>
