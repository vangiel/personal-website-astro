...
<ChatBot title="Chat with an AI" mode="general" bubble/>
...
You can find the code for this full project (including my styling) in the [GitHub repository](https://github.com/vangiel/Tutorials-chatbot-astro).
:::
...
This tutorial has guided you through building a basic chatbot component using AstroJS. The complete code can be found in the [GitHub repository](https://github.com/vangiel/Tutorials-chatbot-astro).
